...
<div class="col-md-9">
    ...
    <div class="page-header bg-secondary">
      <img src="vistas/images/icons/pills.svg" class="title-icon"/><h3>Medicamentos</h3>        
    </div>     
   
    <div class="row pull-right" style="margin-bottom:30px;margin-top: 15px;">
            <div class="col-md-6">                               
                <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#modalRegistrarMedicamento">
                    Agregar medicamento
                </button>
            ...
            <?php
                ...
                foreach($datos as $key => $dato){
                    ...
                    <tr>
                        <td>". ($key + 1)  ."</td>
                        <td>{$dato['codigo']}</td> 
                        <td class='text-uppercase'>{$dato['nombreComercial']}</td>                   
